...
<div class="container py-5 pt-5">
    ...
    <h2 class="mb-4">Tambah Produksi</h2>
    <form action="{{ route('produksi.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="kriteria_gaji" name="kriteria_gaji" required>
        </div>
        <div class="mb-3">
            <label for="gaji_per_unit" class="form-label">Gaji Per Unit</label>
            <input type="number" class="form-control" id="gaji_per_unit" name="gaji_per_unit" required>
        </div>
